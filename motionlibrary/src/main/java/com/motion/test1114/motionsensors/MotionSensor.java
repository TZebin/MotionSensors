...
import static com.motion.test1114.motionsensors.MovementDetector.MovementListener;
import static com.motion.test1114.motionsensors.RotationAngleDetector.RotationAngleListener;
import static com.motion.test1114.motionsensors.TiltDirectionDetector.TiltDirectionListener;
import static com.motion.test1114.motionsensors.WristTwistDetector.WristTwistListener;
...
import com.motion.test1114.motionsensors.PinchScaleDetector.PinchScaleListener;
...
import com.motion.test1114.motionsensors.TouchTypeDetector.TouchTypListener;
...
public class MotionSensor {
     ...
     * through {@link MotionSensor#startSensorDetection(SensorDetector)}, because the last one
    ...
    /**
     * Start universal motion detection.
     *
     * @param universalListener the universal motion listener
     */
    public void startUniversalMotionDetection(UniversalNotificationDetector.UniversalListener universalListener) {
        startLibrarySensorDetection(new UniversalNotificationDetector(universalListener), universalListener);
    }
    ...
    /**
     * Stop universal detection.
     *
     * @param universalListener the universal listener
     */
    public void stopUniversalDetection(UniversalNotificationDetector.UniversalListener universalListener) {
        stopLibrarySensorDetection(universalListener);
    }
