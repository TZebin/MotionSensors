...
import com.motion.test1114.motionsensors.PinchScaleDetector;
import com.motion.test1114.motionsensors.TouchTypeDetector;
...
public class TouchActivity extends AppCompatActivity
    ...
    protected void onPause() {
        ...
        // Stop Detections
        MotionSensor.getInstance().stopTouchTypeDetection();
        MotionSensor.getInstance().stopPinchScaleDetection();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        MotionSensor.getInstance().setupDispatchTouchEvent(event);
